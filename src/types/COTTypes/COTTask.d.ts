...
declare type queryTaskFilterOptions = {
  limit?: number, limitBy?: 'all' | 'group'
}

declare type FilteredTasks = {
  _id: {
    key: string
    display: string
    type: string
